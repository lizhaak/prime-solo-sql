...
-- 3. The bank is giving a new customer bonus! Update all records with an account balance of 0.00 and
...
SELECT account_balance, username
FROM syntax_practice
ORDER BY syntax_practice.account_balance ASC
LIMIT 3;
...
VALUES ('liz', 'hastings', '5', '8', '1000000000.00');
